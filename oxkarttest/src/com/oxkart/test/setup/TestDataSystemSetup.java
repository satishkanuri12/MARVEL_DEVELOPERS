...
import com.oxkart.test.constants.OxkartTestConstants;
import com.oxkart.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = OxkartTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/oxkarttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/oxkarttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/oxkarttest/import/cstickets.impex");
			...
			importImpexFile(context, "/oxkarttest/import/csquotes.impex");
		}
	}
}
