...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/oxkartstorefront/electronics/en",
						"https://electronics.local:9002/oxkartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/oxkartstorefront/electronics/en",
						"https://electronics.local:9002/oxkartstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/oxkartstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/oxkartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/oxkartstorefront/electronics/en",
						"https://electronics.local:9002/oxkartstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/oxkartstorefront",
						"https://electronics.local:9002/oxkartstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/oxkartstorefront",
						"https://electronics.local:9002/oxkartstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/oxkartstorefront/electronics/en",
						"https://electronics.local:9002/oxkartstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
