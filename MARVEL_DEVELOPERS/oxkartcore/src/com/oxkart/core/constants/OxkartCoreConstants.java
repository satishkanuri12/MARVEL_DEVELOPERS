 ...
 */
package com.oxkart.core.constants;

/**
 * Global class for all OxkartCore constants. You can add global constants for your extension into this class.
 */
public final class OxkartCoreConstants extends GeneratedOxkartCoreConstants
{
	public static final String EXTENSIONNAME = "oxkartcore";


	private OxkartCoreConstants()
	{
		//empty
	}
